...
class ObjectStoreImpl {
    ...
    _put(meta, rs, opts) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const maxPayload = ((_b = jsi.nc.info) === null || _b === void 0 ? void 0 : _b.max_payload) || 1024;
            meta = meta || {};
            meta.options = meta.options || {};
            let maxChunk = ((_c = meta.options) === null || _c === void 0 ? void 0 : _c.max_chunk_size) || 128 * 1024;
