...
export interface InterceptorService {
    getSuccessContext(data: number, context: ArgumentsHost, startTime: number, options: OgmaInterceptorServiceOptions): LogObject;
    getErrorContext(error: Error | HttpException, context: ArgumentsHost, startTime: number, options: OgmaInterceptorServiceOptions): LogObject;
